...
export function Scene09Finale() {
  ...
  return (
    <group>
      ...
      <Starfield count={5200} opacity={0.88} colorA="#FFFDFB" colorB="#FFD6A5" />
      <Starfield count={1800} rMin={52} rMax={78} opacity={0.28} colorA="#E8D9FF" colorB="#FFE8EE" />
      <Petals count={16} area={[20, 8, 20]} opacity={0.46} />
      <ParticleField preset="reveal" count={90} scale={[18, 8, 18]} color="#FFE8C7" />
      <RevealBurst active />

      <CharacterPair poseKey="final" />
      <Ground radius={34} glow={0.36} color="#2A0E1E" />
